...
#include "Models/Table/TableInternal.h"

Table::Table(Shader* shader, Texture* tex, glm::vec3 pos) {
...
void Table::drawObject(glm::mat4 mP, glm::mat4 mV) {
